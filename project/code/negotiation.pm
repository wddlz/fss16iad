...
// We assume S_RP<B_RP
const int B_RP; // Buyer RESERVED_PRICE
const int S_RP; // seller RESERVED_PRICE

// INITIAL PRICE
const int B_IP; // Buyer Initial Price
const int S_IP; // Seller Initial Price
...
const int Tb; // Buyer Time-deadline
const int TbB; // Buyer start Conceding Time-deadline (for Boulware strat.)
const int Ts; // Seller Time-deadline
const int TsB; // Seller Time-deadline from which stops conceding (for Conceder strat.)

// BUYER INCREMENT, SELLER DECREMENT
// these values characterise Conceder and Boulware gradients for both players.
const int bCinc;  // Buyer Conceder increment
const int bBinc;   // Buyer Boulware increment
const int sCdec;   // Seller Conceder decrement
const int sBdec;   // Seller Boulware decrement
...
const int Kb; // Buyer's switching factor
const int Ks; // Seller's switching factor
...
const Offset; // Offset for the accepting interval [S_RP+Offset,B_RP+Offset]
